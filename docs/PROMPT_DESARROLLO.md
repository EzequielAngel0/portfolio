...
- **Siguiente: F7 · Lanzamiento y perfil** (doc 07): el dueño hace el pase NVDA y los validadores externos (guiones en `docs/rondas/2026-07-06_f6.md`), resuelve D9 (dominio) y D3 (merge de `develop` a `master`); tras el deploy, verificar la URL real (D4), reescribir el `README.md` del repo y publicar perfil/LinkedIn (D5/D6). El beacon de F5 se retoma cuando el dueño resuelva D7.
