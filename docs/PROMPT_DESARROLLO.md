...
- **Siguiente: F7 · Lanzamiento y perfil** (doc 07): D7 y D9 se resolvieron el 2026-07-06 (beacon + CSP integrados; DNS en verde, al dueño solo le falta Enforce HTTPS cuando el certificado termine de emitirse). El dueño hace el pase NVDA y los validadores externos (guiones en `docs/rondas/2026-07-06_f6.md`) y D3 (merge de `develop` a `master`); tras el deploy, verificar la URL real (D4) y que Web Analytics registre visitas, y publicar perfil/LinkedIn (D5/D6). El `README.md` del repo ya quedó reescrito (2026-07-06, rama `docs/readme-nuevo`).
