...
- [hecho] Dirección recibida (2026-07-15): el dueño trajo una maqueta generada con Google Stitch. Capturada en `docs/DIRECCION_STITCH.md`.
...
- [ ] Pendiente del dueño: pase visual en Podman (`podman compose up --build`, `http://portfolio:4321`) en ambos temas, ES/EN, 360px, sin JS y reduced motion; luego merge de la rama a `develop` (el agente no lo hace sin su OK).
