...
**Abierto del agente ahora mismo:** las páginas nuevas del portfolio (educación, sobre mí, experiencia ACP) y los chores opcionales. Todo lo demás está hecho.
...
Una página de contenido no llega al umbral de ADR (doc 08): rama `feat/` desde `develop`, con OG regenerada y este doc al día. Prompt de handoff de las dos primeras: [prompts/PROMPT_PAGINAS_EDUCACION_SOBRE_MI.md](prompts/PROMPT_PAGINAS_EDUCACION_SOBRE_MI.md).

- [ ] **Educación** (`/educacion/` + `/en/education/`): CETI Tecnólogo en Desarrollo de Software (ago 2022 - jun 2026, egresado, promedio 94.50/100) e Ingeniería en Desarrollo de Software (ago 2026 - jun 2029, ingreso directo a 3er semestre).
- [ ] **Sobre mí / historia**: bio ampliada, trayectoria y foto, más allá del hero; con una sección de enfoque/intereses (ciberseguridad/AppSec y hardware/maker: embebido, IoT, seguridad de hardware, conectividad IoT tipo LoRa/Matter, PCB, 3D/CAD, domótica, fabricación digital, robótica, del prototipo al producto). Purificador (7mo semestre del CETI) queda como evidencia interna de la formación en hardware, NO como project card (decisión del dueño 2026-07-20).
